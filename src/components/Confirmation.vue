  ...
  <div class="confirmation text-center">
    <b-container>
      <b-card class="bg-dark text-center" v-if="!noYCH">
        ...
        <b-card-body>
          <span class="yes_span">
            <b-button variant="success" @click="confirmAge"
              >Yes</b-button
            > </span
          ><b-button variant="danger" @click="lockout">No</b-button>
          ...
          <b-container>
            <p id="agreement" class="mt-3">
              By clicking "Yes" you are confirming that you are 18 years or
              older, and have agreed to view sexually explicit content.
            </p>
          </b-container>
        </b-card-body>
      </b-card>
